class Macbeth extends Phaser.Scene {
    ...
    create() {
        ...
        this['lady macbeth'] = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'ladymacbeth').setScale(0.15).setOrigin(0, 1);
        this.duncan = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'duncan').setOrigin(0, 1).setScale(0.3);
        this.banquo = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'banquo').setOrigin(0, 1).setScale(0.15);
